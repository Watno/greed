...
public class Player {
    ...
    private final ArrayList<ICanBeInPlay> cardsInPlay = new ArrayList<>();
    private final ArrayList<ICard> keptCards = new ArrayList<>();
    private final ArrayList<Monster> menagerie = new ArrayList<>();
    private final ArrayList<Season> trophies = new ArrayList<>();
